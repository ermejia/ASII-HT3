...
<div class="container py-5">
    <div class="jumbotron text-white jumbotron-image shadow" style="background-image: url(https://sehatalami.co/wp-content/uploads/2020/01/Balanced-diet-sehat-alami-konsep-gizi-seimbang-sehat-alami.jpg);">
        <h2 align="center" class="mb-4">
            Desayuno 2 Antigua Burger
            Q. 18
        </h2>
    </div>
</div>
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Cereal" id="opt1" name="opt1" readonly>
                            </div>
                        </div>
                    </li>
