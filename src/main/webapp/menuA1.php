...
<div class="container py-5">
    <div class="jumbotron text-white jumbotron-image shadow" style="background-image: url(https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-1.2.1&w=1000&q=80);">
        <h2 align="center" class="mb-4">
            Almuerzo 1 Antigua Burger
            Q. 30
        </h2>
    </div>
</div>
            ...
            <div class="container">
                <ul>
                    <li>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <input type="text" class="form-control" placeholder="2" name="idmenu" value="2"  id="idmenu" readonly>
                            </div>
                            <div class="form-group col-md-3">
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Hamburguesa" id="opt1" name="opt1" readonly>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Papas" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <select id="opt2" name="opt2" class="custom-select">
                                    <option value="0" selected>Open this select menu</option>
                                    <option value="13">Fritas</option>
                                    <option value="14">Al Vapor</option>
                                    <option value="15">Horneadas</option>
                                </select>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Postre" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <select id="opt4" name="opt4" class="custom-select">
                                    <option value="0" selected>Open this select menu</option>
                                    <option value="26">Helado</option>
                                    <option value="27">Pastel</option>
                                    <option value="28">Flan</option>
                                    <option value="29">Gelatina</option>
                                </select>
                            </div>
                        </div>
                    </li>

                    <h3 align="center">Extras Menu Almuerzo 1 </h3>
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
