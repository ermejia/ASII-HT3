...
<div class="container py-5">
    <div class="jumbotron text-white jumbotron-image shadow" style="background-image: url(https://vistapointe.net/images/breakfast-3.jpg);">
        <h2 align="center" class="mb-4">
            Desayuno 1 Antigua Burgers
        </h2>
        <h2 align="center" class="mb-4">
            Q. 25
        </h2>
            ...
            <div class="container">
                <ul>
                    <li>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <input type="text" class="form-control" placeholder="1" name="idmenu" value="1"  id="idmenu" readonly>
                            </div>
                            <div class="form-group col-md-3">
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Huevos" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <select id="opt1" name="opt1" class="custom-select">
                                    <option value="0" selected>Open this select menu</option>
                                    <option value="1">Estrellados</option>
                                    <option value="2">Revueltos</option>
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Frijoles" readonly>
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Platanos" readonly>
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Pan" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <select id="opt4" name="opt4" class="custom-select">
                                    <option value="0" selected>Open this select menu</option>
                                    <option value="8">Blanco</option>
                                    <option value="9">Integral</option>
                                </select>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <select id="opt5" name="opt5" class="custom-select">
                                    <option value="0" selected>Open this select menu</option>
                    ...
                    <h3 align="center">Extras Menu Desayuno 1 </h3>
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
