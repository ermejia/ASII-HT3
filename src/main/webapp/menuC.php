...
<div class="container py-5">
    <div class="jumbotron text-white jumbotron-image shadow" style="background-image: url(https://media3.s-nbcnews.com/i/newscms/2019_05/2736521/190131-stock-taco-bar-food-ew-1220p_bc7c9fc25ecd393bfa3d7d35f216edfc.jpg);">
            ...
            <div class="container">
                <ul>
                    <li>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <input type="text" class="form-control" placeholder="6" name="idmenu" value="6"  id="idmenu" readonly>
                            </div>
                            <div class="form-group col-md-3">
                    ...
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input class="form-control"  type="text" placeholder="Tortilla" id="opt3" name="opt3" readonly>
                            </div>
                        </div>
                    </li>
                    ...
                    <h3 align="center">Extras Menu Cena</h3>
                    <li>
                        <div class="form-row">
                            <div class="form-group col-md-6">
